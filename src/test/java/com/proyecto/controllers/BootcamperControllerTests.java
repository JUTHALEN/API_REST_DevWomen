...
@AutoConfigureTestDatabase(replace = Replace.NONE) // para que use nuestra base de datos de sql, en vez de una base de
                                                   // datos en memoria
...
public class BootcamperControllerTests {
    ...
    @Autowired
    private WebApplicationContext context; // Mockito simula las dependencias, por eso hay que explicarle que esto es
                                           // una aplicación web
    // así el mockMvc actúa con seguridad listo para hacer las pruevas a los
    // endpoints
